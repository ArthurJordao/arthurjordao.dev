	...
	positions: [
		{
			...
			highlights: [
				"Replaced a planned database-backed CMS with a GitHub-backed editor: definitions live as versioned YAML and an edit opens a pull request, so review and audit came free and no new infrastructure was needed. Validated it as a proof of concept, shipped two weeks later, and non-engineers now author through it in production.",
