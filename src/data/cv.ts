	...
	positions: [
		...
		},
		{
			...
			highlights: [
				...
				"Built the online underwriting flow in Clojure, over an engine that resolved dependent features as a topologically sorted DAG: scoring the loan being requested, and the path where an applicant it scored as risky could send income proof, which queued a human review before the final answer.",
