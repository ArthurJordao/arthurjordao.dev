	...
	positions: [
		...
		},
		{
			...
			highlights: [
				...
				"Extracted the personal loan domain, payments included, out of the credit platform into a standalone service. The credit platform had been settling and executing payments itself; afterwards we settled boleto and Pix directly with the services that move the money, over Kafka and idempotent end to end.",
